...
public interface MiniUserMapper extends BaseMapper<MiniUser> {
    ...
    List<MiniUser> selectByExampleWithRowbounds(MiniSysUserExample example, RowBounds rowBounds);
    ...
    List<MiniUser> selectByExample(MiniSysUserExample example);
    ...
    int updateByExampleSelective(@Param("record") MiniUser record, @Param("example") MiniSysUserExample example);
    ...
    int updateByExample(@Param("record") MiniUser record, @Param("example") MiniSysUserExample example);
}
