...
public interface UserMapper extends BaseMapper<SysUser> {
     ...
     * @return
     */
    List<SysUserDeptDto> getDepNamesByUserIds(@Param("userIds")List<String> userIds);
     ...
     * @return
     */
    List<SysUserDeptDto> getUserByOrgCode(IPage page, @Param("orgCode") String orgCode, @Param("userParams") SysUser userParams);
