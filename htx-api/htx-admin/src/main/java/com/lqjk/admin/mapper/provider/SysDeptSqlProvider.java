...
public class SysDeptSqlProvider {
    ...
    public String insertSelective(SysDept record) {
        ...
        if (record.getLeaderUuid() != null) {
            sql.VALUES("leader_uuid", "#{leaderUuid,jdbcType=VARCHAR}");
        }

        if (record.getDeptAddress() != null) {
            sql.VALUES("dept_address", "#{deptAddress,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(SysDeptExample example) {
        ...
        sql.SELECT("mobile");
        sql.SELECT("leader_uuid");
        sql.SELECT("dept_address");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLeaderUuid() != null) {
            sql.SET("leader_uuid = #{record.leaderUuid,jdbcType=VARCHAR}");
        }

        if (record.getDeptAddress() != null) {
            sql.SET("dept_address = #{record.deptAddress,jdbcType=VARCHAR}");
        }
