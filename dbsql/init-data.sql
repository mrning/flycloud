-- 初始化管理员账户
INSERT INTO `zacboot-admin`.`sys_user`
(`uuid`, `username`, `password`, `real_name`, `avatar`, `nickname`, `mail`, `phone`, `create_user`, `create_time`,
 `update_user`, `update_time`, `deleted`)
VALUES ('superadmin', 'htx',
        'e10adc3949ba59abbe56e057f20f883e', '管理员',
        'http://minio.jeecg.com/otatest/temp/lgo33_1583397323099.png',
        '管理员', 'htx@163.com', '18611111111', 'A01', now(), 'A01', now(), false);

-- 初始化部门表
INSERT INTO `zacboot-admin`.`sys_dept` (`uuid`, `parent_uuid`, `depart_name`, `description`,
                                    `mobile`, `leader_uuid`, `dept_address`, `deleted`, `create_user`,
                                    `create_time`,
                                    `update_user`, `update_time`)
VALUES ('mainDept', '', '绿球金科', NULL, NULL, NULL, NULL, 0, 'htx',
        now(), 'htx', now());

-- 初始化角色
INSERT INTO `zacboot-admin`.`sys_role` (`uuid`, `role_name`, `role_code`, `description`, `create_user`, `create_time`,
                                    `update_user`, `update_time`, `deleted`)
...
-- 初始化用户 ~ 部门关联表
INSERT INTO `zacboot-admin`.`sys_user_dept` (`uuid`, `user_uuid`, `dept_uuid`, create_user, create_time, update_user,
                                         update_time, deleted)
VALUES ('1255ebc5dfc611eaa09238d5477a5fc1', 'superadmin',
        'mainDept', 'init', now(), 'init', now(), 0);

-- 初始化用户 ~ 角色关联表
INSERT INTO `zacboot-admin`.`sys_user_role` (`uuid`, `user_uuid`, `role_uuid`, create_user, create_time, update_user,
                                         update_time, deleted)
VALUES ('42448bdedfc611eaa09238d5477a5fc1', 'superadmin',
        'adminRole', 'init', now(), 'init', now(), 0);

INSERT INTO `zacboot-admin`.sys_permission (uuid, parent_uuid, name, code, icon, component, url, redirect, sort_no, menu_type,
