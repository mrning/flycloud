...
VALUES ('mainDept', '', '上海飞云科技', NULL, NULL, NULL, NULL, 0, 'htx',
        now(), 'htx', now());
...
INSERT INTO htx.sys_permission (uuid, parent_uuid, name, code, icon, component, url, redirect, sort_no, menu_type,
