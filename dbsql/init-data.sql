...
-- 初始化菜单表
INSERT INTO `flycloud`.`sys_permission` (`uuid`, `parent_id`, `name`, `url`, `component`, `component_name`, `redirect`,
                                         `menu_type`, `perms`, `perms_type`, `sort_no`, `always_show`, `icon`,
                                         `route`, `leaf`, `keep_alive`, `hidden`, `description`, `create_user`,
                                         `create_time`, `update_user`, `update_time`, `deleted`, `rule_flag`, `status`,
