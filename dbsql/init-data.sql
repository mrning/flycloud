-- 初始化管理员账户
INSERT INTO `htx-admin`.`sys_user`
...
-- 初始化部门表
INSERT INTO `htx-admin`.`sys_dept` (`uuid`, `parent_uuid`, `depart_name`, `description`,
...
-- 初始化角色
INSERT INTO `htx-admin`.`sys_role` (`uuid`, `role_name`, `role_code`, `description`, `create_user`, `create_time`,
                                    `update_user`, `update_time`, `deleted`)
...
-- 初始化用户 ~ 部门关联表
INSERT INTO `htx-admin`.`sys_user_dept` (`uuid`, `user_uuid`, `dept_uuid`, create_user, create_time, update_user,
                                         update_time, deleted)
VALUES ('1255ebc5dfc611eaa09238d5477a5fc1', 'superadmin',
        'mainDept', 'init', now(), 'init', now(), 0);

-- 初始化用户 ~ 角色关联表
INSERT INTO `htx-admin`.`sys_user_role` (`uuid`, `user_uuid`, `role_uuid`, create_user, create_time, update_user,
                                         update_time, deleted)
VALUES ('42448bdedfc611eaa09238d5477a5fc1', 'superadmin',
        'adminRole', 'init', now(), 'init', now(), 0);

INSERT INTO `htx-admin`.sys_permission (uuid, parent_uuid, name, code, icon, component, url, redirect, sort_no, menu_type,
