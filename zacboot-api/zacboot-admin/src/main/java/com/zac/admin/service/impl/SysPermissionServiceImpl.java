...
import com.zac.admin.dao.SysPermissionDao;
import com.zac.admin.mapper.SysPermissionMapper;
...
import static com.zac.base.constants.CommonConstant.MENU_TYPE_0;
...
public class SysPermissionServiceImpl extends SysBaseServiceImpl<SysPermissionMapper, SysPermission> implements SysPermissionService {
    ...
    public PageResult<SysPermission> queryPage(PermissionRequest permissionRequest) {
        ...
        pageResult.setDataList(sysPermissionDao.queryPage(permissionRequest,new Page(permissionRequest.getPage(),permissionRequest.getPageSize())));
