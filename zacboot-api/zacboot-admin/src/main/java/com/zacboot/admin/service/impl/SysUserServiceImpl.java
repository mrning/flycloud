...
import com.zacboot.admin.feign.AuthServiceFeign;
...
import com.zacboot.core.entity.admin.*;
...
import com.zacboot.core.response.admin.SysDeptResponse;
import com.zacboot.core.response.admin.SysRoleResponse;
...
public class SysUserServiceImpl extends SysBaseServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public JSONObject userInfo(SysUser sysUser) {
        ...
        String token = authServiceFeign.login(new AuthLoginRequest(sysUser.getUuid(), sysUser.getUsername(), sysUser.getPassword()));
    ...
    public boolean logout(String token) {
        ...
        Result<Boolean> result = authServiceFeign.logout(new AuthLogoutRequest(token, sysUser.getUsername()));
        if (result.isSuccess()) {
