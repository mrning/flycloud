package com.zacboot.common.base.config.esconfig;
...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${zacboot.elasticsearch.cluster-nodes}") String baseUrl, @Value("${zacboot.elasticsearch.check-enabled}") boolean checkEnabled) {
