...
public class PasswordUtil {
    ...
    public static String getPasswordEncode(String passwordPlainText) {
        return MD5Util.MD5Encode(passwordPlainText,CharsetUtil.CHARSET_UTF_8.name());
    }
    ...
    public static Boolean getPasswordMatch(String passwordPlainText, String passwordCypher) {
        return MD5Util.MD5Encode(passwordPlainText, CharsetUtil.CHARSET_UTF_8.name()).equals(passwordCypher);
    }
