...
//import com.zacboot.gateway.security.authentication.CustomAuthenticationEntryPoint;
...
//
//    public CustomAuthenticationProcessingFilter(CustomAuthenticationEntryPoint customAuthenticationEntryPoint, AuthenticationSuccessHandler securityLoginSuccessHandler, AuthenticationFailureHandler securityLoginFailHandler) {
//        super(new AntPathRequestMatcher("/sys/login", "POST"));
//        this.setAuthenticationManager(customAuthenticationEntryPoint);
//        // 认证成功逻辑
