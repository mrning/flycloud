package com.zac.flycloud.start.dao.mapper.provider;

import com.zac.flycloud.start.bean.dtos.SysUserDeptDTO;
...
public class SysUserDeptDTOSqlProvider {
    /**
     ...
     * @mbg.generated Fri Apr 30 23:29:25 CST 2021
     */
    public String insertSelective(SysUserDeptDTO record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sys_user_dept");
    ...
    protected void applyWhere(SQL sql, SysUserDeptExample example, boolean includeExamplePhrase) {
        ...
        List<SysUserDeptExample.Criteria> oredCriteria = example.getOredCriteria();
        boolean firstCriteria = true;
        for (int i = 0; i < oredCriteria.size(); i++) {
            SysUserDeptExample.Criteria criteria = oredCriteria.get(i);
            if (criteria.isValid()) {
                if (firstCriteria) {
                    firstCriteria = false;
                } else {
                ...
                sb.append('(');
                List<SysUserDeptExample.Criterion> criterions = criteria.getAllCriteria();
                boolean firstCriterion = true;
                for (int j = 0; j < criterions.size(); j++) {
                    SysUserDeptExample.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
