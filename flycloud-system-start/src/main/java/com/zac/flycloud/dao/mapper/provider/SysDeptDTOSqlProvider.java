...
import com.zac.flycloud.bean.dto.example.SysDeptDTOExample.Criteria;
import com.zac.flycloud.bean.dto.example.SysDeptDTOExample.Criterion;
import com.zac.flycloud.bean.dto.example.SysDeptDTOExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SysDeptDTOSqlProvider {
    /**
     ...
     */
    public String countByExample(SysDeptDTOExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 22:36:02 CST 2021
     */
    public String deleteByExample(SysDeptDTOExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 22:36:02 CST 2021
     */
    public String insertSelective(SysDeptDTO record) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 22:36:02 CST 2021
     */
    public String selectByExample(SysDeptDTOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysDeptDTO record = (SysDeptDTO) parameter.get("record");
        SysDeptDTOExample example = (SysDeptDTOExample) parameter.get("example");
     ...
     * @mbg.generated Fri Apr 30 22:36:02 CST 2021
     */
    protected void applyWhere(SQL sql, SysDeptDTOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
