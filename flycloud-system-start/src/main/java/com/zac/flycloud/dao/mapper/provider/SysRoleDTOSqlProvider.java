...
import com.zac.flycloud.bean.dto.example.SysRoleDTOExample.Criteria;
import com.zac.flycloud.bean.dto.example.SysRoleDTOExample.Criterion;
import com.zac.flycloud.bean.dto.example.SysRoleDTOExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SysRoleDTOSqlProvider {
    /**
     ...
     */
    public String countByExample(SysRoleDTOExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 23:19:11 CST 2021
     */
    public String deleteByExample(SysRoleDTOExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 23:19:11 CST 2021
     */
    public String insertSelective(SysRoleDTO record) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Fri Apr 30 23:19:11 CST 2021
     */
    public String selectByExample(SysRoleDTOExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysRoleDTO record = (SysRoleDTO) parameter.get("record");
        SysRoleDTOExample example = (SysRoleDTOExample) parameter.get("example");
     ...
     * @mbg.generated Fri Apr 30 23:19:11 CST 2021
     */
    protected void applyWhere(SQL sql, SysRoleDTOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
