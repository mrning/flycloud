 ...
 */
@Slf4j
public class HtxSentinelInvocationHandler implements InvocationHandler {
	...
	HtxSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			HtxSentinelInvocationHandler other = (HtxSentinelInvocationHandler) obj;
