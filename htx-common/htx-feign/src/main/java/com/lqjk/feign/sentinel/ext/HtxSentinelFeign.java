package com.lqjk.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class HtxSentinelFeign {

	private HtxSentinelFeign() {

	}

	public static HtxSentinelFeign.Builder builder() {
		return new HtxSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public HtxSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new HtxSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new HtxSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new HtxSentinelInvocationHandler(target, dispatch);
				}
