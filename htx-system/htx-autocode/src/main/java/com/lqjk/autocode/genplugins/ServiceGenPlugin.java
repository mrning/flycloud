package com.lqjk.autocode.genplugins;

import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.lqjk.autocode.constants.MgtConstant;
...
public class ServiceGenPlugin extends PluginAdapter {
    ...
    private GeneratedJavaFile buildServiceFile(String baseDomainName,String fullFileName) {
        ...
        if(fullFileName.contains(MgtConstant.IMPL_SUFFIX)){
            ...
            topLevelClass.addImportedType(new FullyQualifiedJavaType("com.lqjk.base.basebeans.PageResult"));
            ...
            genInterface.addJavaDocLine("/**\n" +
                    ...
                    " * @author zac\n" +
                    " */");
            genInterface.addImportedType(new FullyQualifiedJavaType("com.lqjk.base.basebeans.PageResult"));
            // 继承类
